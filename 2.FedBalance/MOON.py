...
def fit(device, train_loader, val_loader, test_loader, model,prev_model,global_model,
    ...
    for epoch in range(epochs):
        ...
        print('TRAINING')
        train_loss, mean_running_train_loss          =  train_epoch(device, train_loader, model,prev_model,global_model, loss_fn, optimizer, epochs_till_now, final_epoch, log_interval)
        print('VALIDATION')
